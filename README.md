...
1. Chass can detect the tweets of our customers complaints from the **Deep Learning Long Short-Term Memory** model ![icons8-tensorflow-48](https://user-images.githubusercontent.com/103250002/182363125-06fcc93f-5b34-4fee-82a2-da8acd57517f.png), then immediately reply to their tweets one by one without having to think what to caption.
2. Then Chass wants to chat with those who complain more closely so that they are satisfied with the service from my beloved company, namely hacktiv bank via ![icons8-twitter](https://user-images.githubusercontent.com/103250002/182362503-58a1a5ff-5202-4cd2-b73c-8060b08ef186.gif)
 direct message.
3. Then this Chass is made from the **Multinomial Naive Bayes Machine Learning** model ![scikitlearn](https://user-images.githubusercontent.com/103250002/182362975-499612fa-6c55-4e2a-869b-e1046a073edd.svg) so that it can interact with hacktiv bank customers by 2 great people, graduates from Bootcamp Fulltime Data Science Hactiv8.
